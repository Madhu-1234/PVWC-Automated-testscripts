...
class pecoFieldBookPages{
    ...
    */
    ...
    featureLeadSearch_County(county){
        this.search.click()
        browser.pause(5000)
        ...
        browser.pause(3000)
        this.featureSearchFieldDrpdown.addValue('C')
        browser.pause(3000)
        this.featureSearchFieldDrpdown.click({ x: 340, y: 2})
        browser.pause(3000)
        
        this.searchBar.setValue(county)
        this.searchButton_searchWindow.click()
    ...
    measureAreaDisplayed(){
        ...
        var logo = $('#PR3ViewProjectButton_label')
        logo.click({ x: 227, y: 295})
        browser.pause(5000)
        logo.click({ x: 500, y: 295})
        browser.pause(2000)
    ...
    clickOnParcel(){
        var projectLogo = $('//*[@id="PR3ViewProjectButton_label"]')
        projectLogo.click({ x: 237, y: 155})
        browser.pause(7000)
...
module.exports = new pecoFieldBookPages()